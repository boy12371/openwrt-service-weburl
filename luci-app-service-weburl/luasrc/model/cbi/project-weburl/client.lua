m = Map("project-weburl")
m.title = translate("AliyunDrive WebDAV")
m.description = translate("<a href=\"https://github.com/messense/project-weburl\" target=\"_blank\">Project GitHub URL</a>")

m:section(SimpleSection).template = "project-weburl/project-weburl_status"
...
qrcode.rawhtml = true
qrcode.template = 'project-weburl/project-weburl_qrcode'
